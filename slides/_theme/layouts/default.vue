<template>
  <div class="slidev-layout">
    <div v-if="$frontmatter.instructor" class="colmex-instructor-banner">
      Slide solo para el instructor
    </div>
    <img src="/colmex-logo.png" alt="" class="colmex-logo-corner" />
    <slot />
    <div class="colmex-footer">
