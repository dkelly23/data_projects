...
\begin{description}[leftmargin=2em, style=nextline]
    ...
    \item[\textcolor{main}{Parte V --- Productos Finales (semanas 13--16).}] Visualización con \texttt{ggplot2}, automatización de documentos, aplicaciones \texttt{Shiny} e interfaces de modelos de lenguaje.
\end{description}
