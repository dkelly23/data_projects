...
- **Política sobre LLMs:** se introduce explícitamente en S1.1. La visión es que **depender mal de un LLM atrofia la capacidad individual**, pero usado **como agente integrado al proyecto** (Codex de Anthropic, Codex de OpenAI) puede acelerar el trabajo. **Permitido** en el proyecto integrador; **no permitido** en ejercicios de clase. El estudiante debe poder leer y modificar cualquier línea que entregue.
